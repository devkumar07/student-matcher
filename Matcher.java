...
public class Matcher {
	...
	// This method returns an array of index(Projects) that corresponds to the
	// highest preference of a student
	...
	public static void matchRun(String project, String student) {
		String data_student = "data/input/" + student;
		String data_project = "data/input/" + project;
